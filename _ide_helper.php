...
namespace App\Livewire {
    ...
    class AllProducts {
        ...
        public static function modal($name)
        {
            return \App\Livewire\AllProducts::modal($name);
        }
    ...
    class Login {
        ...
        public static function modal($name)
        {
            return \App\Livewire\Login::modal($name);
        }
    ...
    class Dashboard {
        ...
        public static function modal($name)
        {
            return \App\Livewire\Dashboard::modal($name);
        }
    ...
    class ProductsTable {
        ...
        public static function modal($name)
        {
            return \App\Livewire\ProductsTable::modal($name);
        }
